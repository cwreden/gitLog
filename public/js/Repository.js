...
GitLog.Repository = React.createClass({
    ...
    render: function () {
        ...
        var CommitList = GitLog.CommitList;
        return (
            <div className="repository">
                ...
                <Grid>
                    <Row className='show-grid'>
                        ...
                        <Col xs={12} md={8}><CommitList owner={this.props.params.owner} repo={this.props.params.repo} gitTag={this.state.selectedGitTag}/></Col>
                    </Row>
                </Grid>
            </div>
        );
